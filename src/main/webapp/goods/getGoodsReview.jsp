...
<style type="text/css">
	...
	#wrapper{width: 1100px; margin: 50px auto; position: relative; }
	...
	.bkin{width:250px; height:60px; border-radius:10px; background-color:#8A2BE2; border: none; color:#fff; padding: 15px 0; text-align: center;
    text-decoration: none; display: inline-block; font-size: 15px; margin: 4px; cursor: pointer; float:right; }
   ...
   input[type=number] {
	...
	#topBotton{position:fixed; bottom:10px; right:30px; }
	#topBotton i{font-size:50px; border-radius:50px; color:#DCDCDC; border:1px solid #DCDCDC; }
	#insertB{ width:100px; border-radius:10px; background-color: #f8585b; border: none; color:#fff; padding: 15px 0; text-align: center;
    text-decoration: none; display: inline-block; font-size: 15px; margin: 4px; cursor: pointer; }


	#tabwrap1{width: 1100px; height: 50px;margin-top: 100px; box-sizing: border-box; border-bottom: 1px solid #a9a9a9; }
	#tabwrap2{width: 1100px; height: 50px;margin-top: 100px; box-sizing: border-box; border-bottom: 1px solid #a9a9a9; }
	#tabwrap3{width: 1100px; height: 50px;margin-top: 100px; box-sizing: border-box; border-bottom: 1px solid #a9a9a9; }
	#tabwrap4{width: 1100px; height: 50px;margin-top: 100px; box-sizing: border-box; border-bottom: 1px solid #a9a9a9; }
	.tablist{ overflow: hidden; }
	.tablist li{ float: left; width: 200px; height: 50px; background-color: #d9d9d9;  text-align: center; border: 1px solid #a9a9a9; border-left: none; border-bottom: none; box-sizing: border-box;}
	.tablist li:first-child{border-left: 1px solid #a9a9a9; }
	.tablist li.tab1{background-color: #fff;  }
	.tablist li.tab2{background-color: #fff;  }
	.tablist li.tab3{background-color: #fff;  }
	.tablist li.tab4{background-color: #fff;  }
	.tablist > li > a{color: #000; line-height: 50px; font-size: 16px; width:100%; height:100%; display:block;}
	...
	.reviewtb th{border-bottom: 1px solid #d9d9d9; padding: 10px 0;  }
...
<div id="wrapper">
	...
	<div class="mainImg">
		<div class="left_content"><img src="./GoodsUpload/${goods.image01}"  width="430px" height="550px"></div>
			...
			<table align="center">
				...
				<tr style="border-bottom-color: white">
					...
					<div style="text-align: right; font-size: large;">
						총 상품금액: <div id="sum"><fmt:formatNumber value="${goods.price}" pattern="#,###"/>원</div><br><br>
					</div>
...
<div id="tabwrap1">
	...
	<h4>  </h4>
			<div>
				<img src="./GoodsUpload/${goods.image01}" width="500px" height="700px">
				<c:if test="${goods.image02}!=null">
					<img src="./GoodsUpload/${goods.image02}" width="500px" height="700px">
				</c:if>
				<c:if test="${goods.image03}!=null">
				<img src="./GoodsUpload/${goods.image03}" width="500px" height="700px">
				</c:if>
				<p>${goods.content }</p>
			</div>
		</div>
	...
	<div class="content02">
			<div class="detail">
				<img src="./GoodsUpload/${goods.image01}" width="700px" height="500px">
				<p>${goods.content }</p>
			</div>
	...
	<div id="tabwrap4">
		...
		<div class="content4">
		<h4></h4>
		<form name="review" action="../getReviewList.re" method="post" enctype="multipart/form-data">	
			<table class="reviewtb" width="980px" cellspacing="0" cellpadding="15px" align="center">
				<tr>
					<th>번호</th>
					<th>상품이름</th>
					<th>작성자</th>
		...
		<div id="topBotton" >
			<a href="javascript:void(0);"><i class="fas fa-arrow-up" id="top"></i></a>
		</div>
