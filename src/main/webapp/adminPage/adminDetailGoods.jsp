...
<script>
	...
	window.onload = function(){	
		document.getElementById('detailGoods').onsubmit=function(){
			...
			output +='BeginVegan 등록상품이 정상적으로 수정되었습니다.\n\n'
			output +='[등록상품수정]\n'		
			output += '카테고리: '+category+'\n';
			output += '상품명: '+name+'\n';
			output += '상품수량: '+amount+'\n';
			output += '상품가격: '+price+'\n';
			output += '상품이미지 저장경로: '+image+'\n';
...
<div class="w3-container">
	<h3 align="center">상품수정</h3>
 	 <form id="detailGoods" name="detailGoods" action="./modifyGoods.go?seq=${goods.seq}" method="post" enctype="multipart/form-data">
    	...
    	<br><textarea rows="10" cols="120" id="content" name="content">${goods.content}</textarea><br>
