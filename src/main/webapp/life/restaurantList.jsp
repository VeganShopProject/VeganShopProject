...
<div class="content">
	...
	<h1><b>Roasted Vegetables</b><span class="w3-right w3-tag w3-dark-grey w3-round" style="font-size: 30px">9,000</span></h1>
	<p class="w3-text-grey">squash, red bell pepper, potato, red onion, thyme, rosemary, vinegar</p>
	<hr>
	<h1><b>Mashed Peas</b> <span class="w3-right w3-tag w3-dark-grey w3-round" style="font-size: 30px">12,000</span></h1>
	<p class="w3-text-grey">olive oil, peas, mint leaves, butter, browns sugar, green onion</p>
	<hr>
	<h1><b>Potatoes</b> <span class="w3-right w3-tag w3-dark-grey w3-round" style="font-size: 30px">22,000</span></h1>
	...
	<div class="w3-container w3-white w3-padding-32">
	<h1><b>Red Salad</b><span class="w3-right w3-tag w3-dark-grey w3-round" style="font-size: 30px">12,000</span></h1>
	<p class="w3-text-grey">cherry tomatoes, vegetable oil, cider vinegar, parsley, basil</p>
	<hr>
	<h1><b>Bean Salad</b> <span class="w3-right w3-tag w3-dark-grey w3-round" style="font-size: 30px">15,000</span></h1>
	<p class="w3-text-grey">beans, walnuts, maple syrup, letucce, orange, juice, goat cheese</p>
	<hr>
	<h1><b>Papper Salad</b> <span class="w3-right w3-tag w3-dark-grey w3-round" style="font-size: 30px">15,000</span></h1>
	...
	<div class="w3-container w3-white w3-padding-32">
	<h1><b>Juice</b> <span class="w3-tag w3-grey w3-round">Seasonal</span>
	<span class="w3-right w3-tag w3-dark-grey w3-round" style="font-size: 30px">6,000</span></h1>
	<p class="w3-text-grey">orange, tomato, apple</p>
	<hr>
	<h1><b>Tea</b> <span class="w3-right w3-tag w3-dark-grey w3-round" style="font-size: 30px">6,000</span></h1>
	<p class="w3-text-grey">black, green, earl grey, ceylon</p>
	<hr>
	<h1><b>Coffee</b> <span class="w3-right w3-tag w3-dark-grey w3-round" style="font-size: 30px">6,000</span></h1>
	<p class="w3-text-grey">arabika, robusta, chicory</p>
   	...
   	<div class="adress">
   	<br><br><h1>Reservation</h1><p>단체석, 포장, 예약, 무선 인터넷, 반려동물 동반, 남/녀 화장실 구분, 제로페이</p>
   		<form action="/action_page.php" target="_blank">
	 		<p><input class="w3-input w3-padding-16 w3-border" type="text" placeholder="Name" required name="Name"></p>
   			<p><input class="w3-input w3-padding-16 w3-border" type="number" placeholder="How many people" required name="People"></p>
   			<p><input class="w3-input w3-padding-16 w3-border" type="datetime-local" placeholder="Date and time" required name="date" value="2020-11-16T20:00"></p>
   			<p><input class="w3-input w3-padding-16 w3-border" type="text" placeholder="Message \ Special requirements" required name="Message"></p>
   			<p><button class="w3-button w3-black" type="submit" style="background-color:#213421 !important; float:right; " >예약하기</button></p>
   		</form><br><br>
 	</div>
 </div> 
