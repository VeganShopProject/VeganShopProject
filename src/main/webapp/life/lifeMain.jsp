...
<jsp:include page="/main/banner.jsp" />
	...
	<div class="contentall">
		...
		<div class="image03"></div> 
  		<div class="menu03">
  			<br><p class="title" style="line-height: 1.2;" ><b>It’s Easy to Find
  			<br>the Vegan Restaurant!</b></p>
     	...
     	<div class="menu04">
  			<br><p class="title" style="line-height: 1.2;" ><b>It’s Easy to Buy
  			<br>the Vegan Food!</b></p>
