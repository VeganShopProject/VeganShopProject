					...
					<tr>
						...
						<td>
							<!-- <div style="line-height: 2; text-align: center;">
								<a href="javascript:idCheckAction(id)" id="style2" onclick="return idBlankCheck()"
									style="font-family: 'Nanum Gothic', sans-serif; text-decoration: none; 
											display: inline-block; width:60px; height:30px; margin: 10px; border-color: #213429; color: #213429;">
										중복확인
								</a>
							</div> -->
