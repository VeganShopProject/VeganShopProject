...
function openConfirmId(loginform){	
	var url="./memberFind.jsp";
	open(url, "confirm", "toolbar=no,location=no,status=no,menubar=no,"+
						 "scrollbars=no,resizable=no,width=450,height=300,left=700,top=100");
}
</script>
	...
	<tr>
		<td colspan="2" align="center" >
			<table border="0" cellpadding="0" cellspacing="0" width="500">
				<!--회원 로그인 -->
				<tr>
					<form action="../memberLogin.me" method="post" name="loginform">
					<td><br><br>
																...
																<tr>
																	<td height=25 colspan=6 align="center">
																		<input
																			...
																			onclick="javascript:window.location='./memberJoin.jsp'">
																		<a href="#">
